...
fn_scheme_symbol(*) {
    ...
    symbolStyleGui(info) {
        ...
        g.AddLink(, '相关链接: <a href="https://inputtip.abgox.com/faq/inputtip-for-vscode">InputTip for VSCode</a>   <a href="https://github.com/abgox/InputTip/issues/145">Github Issue 145</a>')
        return g
    }
}
