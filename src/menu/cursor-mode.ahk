...
fn_cursor_mode(*) {
    ...
    showGui(deep := 0) {
        ...
        modeGui(info) {
            ...
            LV := "LV_" A_Now
            gc.%LV% := g.AddListView("xs -LV0x10 -Multi r9 NoSortHdr Sort Grid w" w, ["进程名称", "光标获取模式", "创建时间"])
