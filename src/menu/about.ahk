...
fn_about(*) {
    ...
    aboutGui(info) {
        ...
        g.AddLink("xs", '    - 这些留言内容将会显示在 <a href="https://abgox.com/donate-list">abgox.com/donate-list</a> 这个赞赏名单中')
        g.AddLink("xs", '    - 如果不想显示在其中，也可以留言说明，会完全匿名处理')
        g.AddLink("xs", '- 也可以直接访问我的个人主页: <a href="https://abgox.com">abgox.com</a>')
