...
updateTrayTip(flag := "") {
    if (var.enableCustomTrayTip) {
        var.trayTipTemplate := readIni("trayTipTemplate", i18n("trayTipTemplate.content"))
    } else {
        var.trayTipTemplate := i18n("trayTipTemplate.content")
    }

    if (var.enableKeyStats) {
        var.keyStatsTemplate := readIni("keyStatsTemplate", i18n("keyStatsTemplate.content"))
        if (flag != "") {
